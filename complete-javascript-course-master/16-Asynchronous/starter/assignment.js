...
const loadNPause = async function () {
  try {
    const createImgRes1 = await createImage('/img/img-1.jpg');
    currentImg = createImgRes1;
    console.log('Image 1 loaded');
    await wait(2);

    currentImg.style.display = 'none';
    const createImgRes2 = await createImage('img/img-2.jpg');
    currentImg = createImgRes2;
    console.log('Image 2 loaded');
    await wait(2);
...
const loadNPauseT = async function () {
  try {
    // Load image 1
